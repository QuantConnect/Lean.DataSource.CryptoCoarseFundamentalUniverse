...
namespace QuantConnect.Data.UniverseSelection
{
    ...
    /// </summary>
    public class CryptoCoarseFundamentalUniverse : Universe
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CryptoCoarseFundamentalUniverse"/> class
        /// </summary>
        ...
        public CryptoCoarseFundamentalUniverse(string market, UniverseSettings universeSettings, Func<IEnumerable<CryptoCoarseFundamental>, IEnumerable<Symbol>> selector)
            : base(CreateConfiguration(CryptoCoarseFundamental.CreateUniverseSymbol(market)))
        {
        ...
        {
            _universeSettings = universeSettings;
            Func<IEnumerable<CryptoCoarseFundamental>, object> func;
        ...
        {
            return _selector(data.Data.OfType<CryptoCoarseFundamental>());
        }

        /// <summary>
        /// Creates a <see cref="CryptoCoarseFundamental"/> subscription configuration for the selected Crypto market
        /// </summary>
        ...
        {
            return new SubscriptionDataConfig(typeof (CryptoCoarseFundamental),
                symbol: symbol,
